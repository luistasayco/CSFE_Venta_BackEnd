...
namespace Net.Data
{
    public interface IRecetaRepository : IRepositoryBase<BE_Receta>
    {
        ...
        Task<ResultadoTransaccion<BE_Receta>> GetListRecetasAPUPorFiltro(DateTime fechainicio, DateTime fechafin, string codtipoconsultamedica, int ide_receta, string nombrespaciente, string sbaestadoreceta);
