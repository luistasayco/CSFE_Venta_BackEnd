...
namespace Net.Data
{
    public interface IVentasNotaRepository
    {
        ...
        Task<ResultadoTransaccion<BE_VentasNota>> GetNotaCabeceraPorFiltro(string codcomprobante, string codventa, DateTime fecinicio, DateTime fecfin, string codnota, string anombredequien, string codtipocliente);
