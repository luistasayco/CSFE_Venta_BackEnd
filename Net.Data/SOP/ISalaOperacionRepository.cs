...
namespace Net.Data
{
    public interface ISalaOperacionRepository : IRepositoryBase<BE_SalaOperacion>
    {
        ...
        Task<ResultadoTransaccion<BE_SalaOperacion>> Modificar(BE_SalaOperacionXml value);
        ...
        Task<ResultadoTransaccion<BE_SalaOperacion>> GetSalaOperacionPorId(int idborrador);
    }
}
