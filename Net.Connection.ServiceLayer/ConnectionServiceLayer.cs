...
namespace Net.Connection.ServiceLayer
{
    public class ConnectionServiceLayer
    {
        ...
        public async Task<T> PostCancelAsyncSBA<T>(string Query)
        {
            try
            {
                // CONSTRUIMOS LA URL DE LA ACCIÓN
        ...
        public async Task<T> DeleteAsyncSBA<T>(string Query)
        {
            try
            {
                // CONSTRUIMOS LA URL DE LA ACCIÓN
        ...
        public async Task<T> PatchAsyncSBA<T>(string Query, object obj)
        {
            try
            {
                // CONSTRUIMOS LA URL DE LA ACCIÓN
        ...
        public async Task<List<T>> GetBaseAsync<T>(string Query, int maxpagesize = 20)
        {
            try
            {
                // CONSTRUIMOS LA URL DE LA ACCIÓN
            ...
            band:
                ...
                using (var request_ = new HttpRequestMessage())
                {
                    ...
                    request_.Headers.Accept.Add(MediaTypeWithQualityHeaderValue.Parse("application/json"));
                    request_.Headers.Add("cache-control", "no-cache");
                    request_.Headers.Add("Prefer", "odata.maxpagesize=" + maxpagesize.ToString());
