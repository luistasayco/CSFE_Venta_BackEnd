...
{
    public class BE_ComprobanteElectronicoLogXmlCabPrint
    {

        public string codcomprobante { get; set; }
        public string codcomprobante_e { get; set; }
        ...
        public string tipomov_vta { get; set; }
        ...
        public string efact_sunat_resol { get; set; }
