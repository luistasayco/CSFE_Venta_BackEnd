...
namespace Net.TCI
{
    ...
    {
        public string GetComprobateElectronicoXml(List<BE_ComprobanteElectronico> response)
        {
            //
            string XMLT;
            string XML_1;
        ...
        public string GetComprobateElectronicoDetalleXml(List<BE_ComprobanteElectronico> response)
        {
            string XMLT;
            string XML2;
            string XML3;
        ...
        public bool InvokeWebService_TCI(string strSoap, string strSOAPAction, string strURL, DOMDocument30 xmlResponse)
        {
            bool blnSuccess;
