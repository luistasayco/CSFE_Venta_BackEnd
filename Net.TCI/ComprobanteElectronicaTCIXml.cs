...
namespace Net.TCI
{
    public class ComprobanteElectronicaTCIXml
    {
        ...
        public string f_ENComprobante_LOG(List<BE_ComprobanteElectronico> response)
        {
            ...
            string XMLT = string.Empty;
            string XML_1 = string.Empty;
            string XML_2 = string.Empty;
            string XML_3 = string.Empty;
            string XML_4 = string.Empty;
            string XML_5 = string.Empty;
            string XML_6 = string.Empty;
            string XML_7 = string.Empty;
            string XML_8 = string.Empty;
            string XML_9 = string.Empty;
            string XML_11 = string.Empty;
            string XML_12 = string.Empty;
            string XML_Detalle = string.Empty;

            string wCuadre = string.Empty;                          //'ref
            string wTipoPlantilla = "EST";                          //'ENComprobante.TipoPlantilla
            string wTipoComp_Sunat = string.Empty;                  //'ENComprobante.TipoComprobante
            string wSerie = string.Empty;                           //'ENComprobante.Serie
            string wNumero = string.Empty;                          //'ENComprobante.Numero
            string wFechaEmision = string.Empty;                    //'ENComprobante.FechaEmision
                                                                    //'wMoneda = "PEN"                                      //'ENComprobante.Moneda; Catalogo02: "PEN" = Nuevo Sol, "USD" = Dolares; En Farmacia todas las ventas son en SOLES
            string wMoneda = string.Empty;                          //'AGARCIA.25/11/2016


            string wReceptor_Anombrede = string.Empty;              //'ENComprobante.RazonSocial; Tipo Dato : an(100)
            string wReceptor_Direccion = string.Empty;              //'ENComprobante.ENReceptor.Calle;   Tipo Dato : an(500)
            string wReceptor_TipoDocIdentidad = string.Empty;       //'ENComprobante.TipoDocumentoIdentidad; Catalogo no. 06: Códigos de tipos de documentos de identidad
            string wReceptor_Ruc = string.Empty;                    //'ENComprobante.Ruc; Tipo Dato : an(11)
            string wReceptor_Correo = string.Empty;                 //'ENComprobante.CorreoElectronico;                         FALTA DEFINIR
                                                                    //'I-EnEmpresa
            string wEmpresa_Ruc = string.Empty;                     //'ENComprobante.ENEmpresa.Ruc
            string wEmpresa_TipoDocIdentidad = "6";                 //'ENComprobante.ENEmpresa.TipoDocumentoIdentidad
            string wEmpresa_Nombre = string.Empty;                  //'ENComprobante.ENEmpresa.RazonSocial
            string wEmpresa_Direccion = string.Empty;               //'ENComprobante.ENEmpresa.Calle
            string wEmpresa_Telefono = string.Empty;                //'ENComprobante.ENEmpresa.Telefono
                                                                    //'F-EnEmpresa
                                                                    //'I-salud
            string wConcepto = string.Empty;                        //'ENComprobante.ENSalud.Concepto
            string wCodventa = string.Empty;                        //'ENComprobante.ENSalud.Liquidacion
            string wCodAtencion = string.Empty;                     //'ENComprobante.ENSalud.OA
            string wCodPaciente = string.Empty;                     //'ENComprobante.ENSalud.HistoriaClinica
            string wNombrePaciente = string.Empty;                  //'ENComprobante.ENSalud.Paciente
            string wNombreTitular = string.Empty;                   //'ENComprobante.ENSalud.Titular
            string wNombreContratante = string.Empty;               //'ENComprobante.ENSalud.Empresa
            string wPoliza = string.Empty;                          //'ENComprobante.ENSalud.Poliza
            string wCoaseguro = "0";                                //'ENComprobante.ENSalud.Coaseguro
                                                                    //'F-salud
            string wObservaciones = "";                             //'ENComprobante.Glosa; Tipo Dato: an(1000)
            string wTexto1 = "";                                    //'ENComprobante.ENTexto.texto1; Tipo Dato : an(1000);      FALTA???
            string wSucursal_Direccion = "";                        //'ENComprobante.ENSucursal.Direccion; Tipo Dato : an(300); FALTA??
            ...
            string wTextoGratuito = "";                             //'ENComprobante.ENComprobantePropiedadesAdicionales.Valor;  an(100)

            string wPorcentajeIGV = "0";                                   //'
            string wMontoNeto = "0";                                       //'ENComprobante.ImporteTotal; Formato n(12,2) Ej:12000.00 //'con Igv
                                                                            //'wMontoTotal = "0;"                                   //'Subtotal(sinIgv); catalogo_Nro_14
            string wMontoGravado = "0";                                    //'ENComprobante.ENComprobanteMontosAdicionalesObligatorios.Codigo =10001; para Total Valor Venta - Operaciones Gravadas  = Subtotal(sinIgv); catalogo_Nro_14
            string wMontoInafecto = "0";                                   //'ENComprobante.ENComprobanteMontosAdicionalesObligatorios.Codigo =10002; para Total Valor Venta - Operaciones Inafectas
            string wMontoExonerado = "0";                                  //'ENComprobante.ENComprobanteMontosAdicionalesObligatorios.Codigo =10003; para Total Valor Venta - Operaciones Exoneradas
            string wMontoGratuito = "0";                                   //'ENComprobante.ENMontosAdicionalesOtros.Codigo = 1004; para Total Valor Venta - Operaciones Gratuitas
                                                                            //'Impuestos Cabecera:
            ...
            string wFlgGratuito = string.Empty;               //'ref AGARCIA.11/07/2016
            ...
            string wCodcomprobante = response[0].codcomprobante;
            ...
            if (response.Count > 0)
            {
                ...
                wReceptor_Anombrede = response[0].anombrede.Trim();                                                        //'RazonSocial
                wReceptor_Direccion = response[0].direccion.Trim();                                                        //'ENReceptor.Calle
                wReceptor_TipoDocIdentidad = response[0].tipdocidentidad_sunat;//1
                ...
                wEmpresa_Nombre = response[0].empresa_nombre.Trim();                                                       //'ENComprobante.ENEmpresa.RazonSocial
                wEmpresa_Direccion = response[0].empresa_dicreccion;                                                //'ENComprobante.ENEmpresa.Calle
                wEmpresa_Telefono = response[0].empresa_telefono.Trim();                                                   //'ENComprobante.ENEmpresa.Telefono
                                                                                                                            //'F-EnEmpresa
                                                                                                                            //'I-EnSalud
                ...
                wNombrePaciente = response[0].nombrepaciente.Trim();                                                       //'ENComprobante.ENSalud.Paciente
                ...
                wObservaciones = response[0].observaciones.Trim();
                wTexto1 = response[0].texto1.Trim();                                                                       //'ENTexto.texto1
                wSucursal_Direccion = response[0].suc_direccion.Trim();                                                    //'ENSucursal.Direccion
                ...
                if (wCodcomprobante.Substring(0, 1) == "C" | wCodcomprobante.Substring(0, 1) == "D")
                {
                    ...
                    {
                        wRef_Serie = response[0].ref_codcomprobantee.Substring(0, 4);
                        wRef_Numero = response[0].ref_codcomprobantee.Substring(4);
                    }
                    else if (wRef_CodComprobanteE.Length == 11)
                    {
                        wRef_Serie = response[0].ref_codcomprobantee.Substring(0, 3);
                        wRef_Numero = response[0].ref_codcomprobantee.Substring(3);
                    }
                }
                ...
                XML_3 = "<Salud>" + secuencia +
                            ...
                            "<OAM>" + wCodAtencion?.Trim() + "</OAM>" + secuencia +
                ...
                if (XML_Detalle != "")
                {
                    ...
                    XMLT = XMLT + "</ENReceptor>" + secuencia;
                    XMLT = XMLT + "</Receptor>" + secuencia;
                    XMLT = XMLT + "<TipoDocumentoIdentidad>" + wReceptor_TipoDocIdentidad + "</TipoDocumentoIdentidad>" + secuencia;//1
                    XMLT = XMLT + "<Ruc>" + wReceptor_Ruc + "</Ruc>" + secuencia;
                    XMLT = XMLT + "<CorreoElectronico>" + wReceptor_Correo.Trim() + "</CorreoElectronico>" + secuencia;
                    ...
                    XMLT = XMLT + "<FormaPagoSunat><TipoFormaPago>1</TipoFormaPago></FormaPagoSunat>" + secuencia;
        ...
        private string GetComprobateElectronicoDetalleXml(List<BE_ComprobanteElectronico> response)
        {
            ...
            wMontoTotal = "0";                  //'ENComprobanteDetalle.Total; subtot_sinigv; Valor Venta del Item (Sin impuestos);  TipoDato: n(22,2) Ejemplo: 12000.00 //'sin igv
        ...
        public bool InvokeWebServiceTCI(string strSoap, string strSOAPAction, string strURL, ref DOMDocument30 xmlResponse)
        {
            bool blnSuccess;
            ...
            {
                string datos = ex.Message.ToString();
        ...
        public string Leer_ResponseXML(string strResponseXML, string CampoInicio, string CampoFin)
        {
            ...
            xPos1 = Strings.InStr(1, xCadena, CampoInicio, CompareMethod.Text) + CampoInicio.Length - 1;
            xPos2 = Strings.InStr(1, xCadena, CampoFin, CompareMethod.Text) - 1;
