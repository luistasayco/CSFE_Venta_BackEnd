...
{
    public class DtoNotaElectronicaXmlListarResponse
    {
        public IEnumerable<DtoNotaElectronicaXmlResponse> ListaNotaElectronicaXml { get; set; }

        public DtoNotaElectronicaXmlListarResponse RetornarListaNotaElectronicaXml(IEnumerable<BE_ComprobanteElectronico> listaNotaElectronicaXml)
        {
            IEnumerable<DtoNotaElectronicaXmlResponse> lista = (
                from value in listaNotaElectronicaXml
                select new DtoNotaElectronicaXmlResponse
                {
                    ...
                    ref_electronico = value.ref_electronico,
                    ref_codcomprobantee = value.ref_codcomprobantee,
                    ref_tipocomp_sunat = value.ref_tipocomp_sunat,
                    ref_fechaemision = value.ref_fechaemision,
                    c_codmotivo_sunat = value.c_codmotivo_sunat,
                    c_motivonota = value.c_motivonota,
            ...
            return new DtoNotaElectronicaXmlListarResponse() { ListaNotaElectronicaXml = lista };
        }
    }
}
